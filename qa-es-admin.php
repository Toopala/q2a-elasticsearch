...
class qa_elasticsearch
{
    ...
    function create_es_client_if_needed()
    {
        ...
        if ($this->es_enabled && !$this->es_client) {
            ...
            $this->es_search_type = qa_opt('elasticsearch_search_type');
    ...
    function option_default($option)
    {
        switch ($option) {
            ...
            case 'elasticsearch_search_type':
                return 'query_string';
    ...
    function admin_form(&$qa_content)
    {
        ...
        if (qa_clicked('accept_save_button')) {
            ...
            qa_opt('elasticsearch_search_type', qa_post_text('elasticsearch_search_type'));
        ...
        $fields[] = array(
            'label' => 'Seach type',
            'tags' => 'NAME="elasticsearch_search_type"',
            'value' => qa_opt('elasticsearch_search_type'),
            'type' => 'input',
        );
        return array(
            'ok' => $ok ?? null,
